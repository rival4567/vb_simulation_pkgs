...
class OnlineOrderPlacer:
    ...
    def __init__(self):
        ...
        param_online_order_intervals = rospy.get_param(
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        if((sim_time_now.secs == online_order._interval_list[0]) and (online_order._flag_order_placed_1 is False)):
            online_order.place_online_order(
                "3001", "Clothes", "1", "Mumbai", "19.0760 N", "72.8777 E")
        ...
        # 28.7041 N, 77.1025 E
            ...
            online_order.place_online_order(
                "1001", "Medicine", "1", "Delhi", "28.7041 N", "77.1025 E")
        ...
        # 13.0827 N, 80.2707 E
            ...
            online_order.place_online_order(
                "2001", "Food", "1", "Chennai", "13.0827 N", "80.2707 E")
        ...
        # 22.5726 N, 88.3639 E
            ...
            online_order.place_online_order(
                "2002", "Food", "1", "Kolkata", "22.5726 N", "88.3639 E")
        ...
        # 18.5204 N, 73.8567 E
            ...
            online_order.place_online_order(
                "3002", "Clothes", "1", "Pune", "18.5204 N", "73.8567 E")
        ...
        # 17.3850 N, 78.4867 E
            ...
            online_order.place_online_order(
                "1002", "Medicine", "1", "Hyderabad", "17.3850 N", "78.4867 E")
        ...
        # 12.9716 N, 77.5946 E
            ...
            online_order.place_online_order(
                "3003", "Clothes", "1", "Bangalore", "12.9716 N", "77.5946 E")
        ...
        # 31.6340 N, 74.8723 E
            ...
            online_order.place_online_order(
                "1003", "Medicine", "1", "Amritsar", "31.6340 N", "74.8723 E")
        ...
        # 23.8315 N, 91.2868 E
            ...
            online_order.place_online_order(
                "2003", "Food", "1", "Agartala", "23.8315 N", "91.2868 E")
