        ...
        if ((self._count > 1) and (number_models == 0)):
            ...
            for i in range(0, number_models):
                ...
                if(lst_name_model[0] == self._attachable_object_prefix):
                    rospy.loginfo('\033[94m' + ">>> [ur5_2] Vacuum Gripper: Pickable object found {}. Pickable: {}".format(
...
def main():
    ...
    s = rospy.Service('/eyrc/vb/ur5/activate_vacuum_gripper/ur5_2',
